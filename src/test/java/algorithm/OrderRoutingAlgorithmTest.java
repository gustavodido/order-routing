...
public class OrderRoutingAlgorithmTest {
    ...
    private static final ShippingItem SHIPPING_BR_MOUSE_4_ITEMS = new ShippingItem("Brazil", "Mouse", 4);
    private static final ShippingItem SHIPPING_FR_MOUSE_1_ITEM = new ShippingItem("France", "Mouse", 1);
    ...
    public void setUp() {
        ...
        algorithm = new OrderRoutingAlgorithm(new InMemoryWarehouseRepository().list(), singletonList(warehouseConstraint));
    ...
    public void shouldFulfillMultiItemOrder() {
        Request request = requestWith(asList(BR_MOUSE_4_ITEM, FR_MOUSE_2_ITEMS), singletonList(ORDER_MOUSE_5_ITEMS));
